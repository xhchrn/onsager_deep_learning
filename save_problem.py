...
# save_problem('problem_k2',problems.bernoulli_gaussian_trial(M=250,N=500,L=1000,pnz=.1,kappa=2,SNR=40))
# save_problem('problem_k3',problems.bernoulli_gaussian_trial(M=250,N=500,L=1000,pnz=.1,kappa=3,SNR=40))
# save_problem('problem_k3d5',problems.bernoulli_gaussian_trial(M=250,N=500,L=1000,pnz=.1,kappa=3.5,SNR=40))
save_problem('problem_k4',problems.bernoulli_gaussian_trial(M=250,N=500,L=1000,pnz=.1,kappa=4,SNR=40))
# save_problem('problem_k4d5',problems.bernoulli_gaussian_trial(M=250,N=500,L=1000,pnz=.1,kappa=4.5,SNR=40))
