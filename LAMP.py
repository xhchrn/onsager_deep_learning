...
prob = problems.bernoulli_gaussian_trial(kappa=1000,M=250,N=500,L=1000,pnz=.1,SNR=40) #a Bernoulli-Gaussian x, noisily observed through a random matrix
...
sess = train.do_training(training_stages,prob,'LAMP_bg_kappa1000.npz')
